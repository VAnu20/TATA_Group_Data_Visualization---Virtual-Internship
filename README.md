...
This repository showcases my work for the Tata Group Data Visualization Virtual Internship hosted on Forage. Throughout this simulation, I stepped into the role of a data consultant to tackle real-world business challenges faced by Tata’s diverse business units. Using Power BI, I transformed complex datasets into actionable visual insights, focusing on clear communication with corporate stakeholders and data-driven decision-making.
